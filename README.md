...
| 항목 | 내용 |
|---|---|
| 구성 | 3층 격리: `docs/`(결정·ADR) · `methodology/`(캐논·스킬) · `runtimes/{ztr, acp}` |
...
| 검증 | 무인 dogfood + **실프로젝트 [Model Forge](https://github.com/SangHun-Kimvalue/Model_Forge)에서 구현-기계검사-테스트-리뷰 무인 사이클 완주**, 독립 리뷰 게이트의 실결함 적발 확인 |
...
- ✅ 실프로젝트 실증 — [Model Forge](https://github.com/SangHun-Kimvalue/Model_Forge)를 이 스위트로 개발
