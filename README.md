...
| 자동화 경계 | 안쪽 루프(구현→기계검사→테스트→리뷰) 4단계 자동 수행 / 페이즈 경계는 사람 승인 |
| 검증 | 구성요소 자동 테스트 475개 이상(ztr 250·ACP 225, 원본 저장소 pytest 수집 기준) · [Model Forge](https://github.com/SangHun-Kimvalue/Model_Forge)에 적용 · 독립 리뷰에서 수정 필요 결함 식별 |
...
- ✅ 반자율 오케스트레이션 — 안쪽 루프 자동 수행 + 페이즈 경계 사람 승인
