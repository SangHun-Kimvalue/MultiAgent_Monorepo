...
- **Gemini API 백엔드는 금지**한다(크레딧 만료·Non-Goal). 필요 시 Gemini **CLI** leg만 D7 binding으로 사용한다.
- 정액제 구독·CLI 기반으로 운용한다.
- **진행 SoT**: 스위트 트랙은 `../../methodology/docs/PHASE_CYCLE_ORCHESTRATOR_DESIGN.md` §10. ztr 내부 로드맵은 `docs/ROADMAP_V2.md`(Phase 1~8 完 — cross-컴포넌트 진행은 §10을 본다).
